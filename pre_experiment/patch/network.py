...
class Network(base_layer.Layer):
  ...
  # lin
  @trackable.no_automatic_dependency_tracking
  def _init_graph_network(self, inputs, outputs, _layer=None, name=None, **kwargs):
    ...
    for x in self.outputs:
      #lin
      if _layer:
        layer, node_index, tensor_index = _layer, 0, 0
      else:
    ...
    nodes, nodes_by_depth, layers, _ = _map_graph_network(
        self.inputs, self.outputs, self._layer)
...
def _map_graph_network(inputs, outputs, _layer):
